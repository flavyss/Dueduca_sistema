...
<head>
    ...
    <link rel="stylesheet" href="assets/css/listaraluno.css">
                ...
                <div class="content">
                    <div class="cell">
                        ...
                        <?php
                            ...
                            foreach($infos as $info){
                                echo '<div class="topic">'.$info['Nome'].' '.$info['Sobrenome'].'</div>';
                            }
                        ?>
                    </div>

                    <div class="cell">
                        <div class="topic">CPF</div>
                        <?php
                            $sql = $pdo->prepare("SELECT * FROM Aluno");
                            $sql->execute();
                            ...
                            foreach($infos as $info){
                                echo '<div class="topic">'.$info['CPF'].'</div>';
                            }
                        ?>
                    </div>
                    ...
                    <div class="cell">
                        ...
                        <?php
                            ...
                            foreach($infos as $info){
                                echo '<div class="topic">'.$info['turma'].'</div>';
                            }
                        ?>
                    </div>
